...
func findTicksRange(v []float64) (min, max float64) {
	...
	dMax := decimal.NewFromFloat(max).Add(decimal.NewFromFloat(-0.005)).Mul(decimal.NewFromFloat(100)).Ceil().Div(decimal.NewFromFloat(100)).Add(decimal.NewFromFloat(0.005))
